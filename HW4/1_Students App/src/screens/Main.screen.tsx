...
const Main = (props: IProps) => {
  ...
  useEffect(() => {
    ...
    const maxAbs = Number(params.get('maxAbs')) || 0;
    ...
    if(minAbs&&maxAbs){
      setFilteredList(oldState => (oldState.filter(std => std.absents>=minAbs && std.absents<=maxAbs)));
    }
  }, [params, studentsList]);
  ...
  return (
    <div className="main-screen">
      ...
      <div className="filter">
        ...
        <input type="number" id="maxAbs" name="maxAbs" min="0" onChange={handleAbsFilter} value={params.get('maxAbs')||'0'}/>
        <div>
          {
